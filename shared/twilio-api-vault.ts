    ...
    subcategories: [
      {
        id: "campaigns",
        name: "SMS Campaigns",
        description: "Bulk marketing SMS and promotional messages",
      },
      {
        id: "sequences",
        name: "Drip Sequences",
        description: "Automated marketing message sequences",
      },
      {
        id: "segmentation",
        name: "Segmentation",
      ...
      },
      {
        ...
        description: "Marketing performance tracking",
      },
    ],
  },
  {
    ...
    description:
      "Regulatory compliance, opt-in/out management, and SPAM prevention",
    icon: "Shield",
    subcategories: [
      {
        id: "opt-management",
        name: "Opt-In/Out",
        description: "Subscription consent management",
      },
      {
        id: "compliance-check",
        name: "Compliance Check",
        description: "Message compliance validation",
      },
      {
        id: "carrier-filtering",
        name: "Carrier Filtering",
        description: "Carrier-level SPAM protection",
      },
      {
        id: "regulatory",
        name: "Regulatory",
        description: "TCPA, CAN-SPAM compliance tools",
      },
    ],
  },
  {
    ...
    name: "Billing & Usage",
    description:
      "Payment notifications, usage tracking, and billing communications",
    icon: "CreditCard",
    subcategories: [
      {
        id: "payment-reminders",
        name: "Payment Reminders",
        description: "Automated billing reminders",
      },
      {
        id: "failed-payments",
        name: "Failed Payments",
        description: "Failed payment recovery messaging",
      },
      {
        id: "usage-alerts",
        name: "Usage Alerts",
        description: "Service usage notifications",
      },
      {
        id: "billing-confirmations",
        name: "Confirmations",
    ...
    subcategories: [
      {
        ...
        description: "Automated support communications",
      },
      {
        id: "status-updates",
        name: "Status Updates",
        description: "Service status and maintenance alerts",
      },
      {
        id: "escalations",
        name: "Escalations",
        description: "Support escalation notifications",
      },
      {
        id: "satisfaction",
        name: "Satisfaction",
    ...
    subcategories: [
      {
        id: "welcome-series",
        name: "Welcome Series",
        description: "New customer onboarding sequences",
      },
      {
        id: "activation",
        name: "Activation",
        description: "Account activation and setup",
      },
      {
        id: "retention",
        name: "Retention",
      ...
      },
      {
        id: "winback",
        name: "Win-back",
        description: "Churn prevention and win-back campaigns",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        id: "login-alerts",
        name: "Login Alerts",
        description: "Suspicious login notifications",
      },
      {
        id: "password-reset",
        name: "Password Reset",
    ...
    subcategories: [
      {
        id: "sales-calls",
        name: "Sales Calls",
        description: "Automated sales and follow-up calls",
      },
      {
        id: "support-calls",
        name: "Support Calls",
        description: "Customer support voice interactions",
      },
      {
        id: "reminders",
        name: "Voice Reminders",
        description: "Automated voice reminders",
      },
      {
        id: "ivr",
        name: "IVR Systems",
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        id: "roi-tracking",
        name: "ROI Tracking",
        description: "Communication ROI measurement",
      },
      {
        id: "performance",
        name: "Performance",
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        description: "Bulk messaging and operations",
      },
      {
        id: "real-time",
        name: "Real-time APIs",
