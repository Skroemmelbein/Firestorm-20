...
export const ALL_TWILIO_APIS: TwilioAPIEndpoint[] = [
  ...
  // =============================================================================
  {
    ...
    name: "Verify API",
    description:
      "Phone number verification service for secure customer onboarding",
    method: "POST",
  ...
  },
  {
    ...
    optionalParams: [
      ...
      },
      {
        name: "FriendlyName",
        type: "string",
        description: "Number friendly name",
      },
    ],
  ...
  // =============================================================================
  {
    ...
    name: "SMS API",
    description:
      "Send SMS messages for billing notifications and payment reminders",
    method: "POST",
    path: "/2010-04-01/Accounts/{AccountSid}/Messages",
    category: "billing-communications",
    subcategory: "Payment Notifications",
    businessFunction:
      "Payment reminders, failed payment alerts, billing notifications",
    ...
    optionalParams: [
      { name: "MediaUrl", type: "string", description: "Media attachment URL" },
      {
        name: "StatusCallback",
        type: "string",
        description: "Delivery status webhook URL",
      },
    ],
  ...
  },
  {
    ...
    requiredParams: [
      { name: "To", type: "string", description: "Recipient phone number" },
      {
        name: "From",
        type: "string",
        description: "Alpha sender ID (company name)",
      },
      { name: "Body", type: "string", description: "Message content" },
    ],
    optionalParams: [],
  ...
  },
  {
    ...
    requiredParams: [
      ...
      { name: "Status", type: "string", description: "Flow status" },
      {
        name: "Definition",
        type: "object",
        description: "Flow definition JSON",
      },
    ],
    optionalParams: [
      {
    ...
    requiredParams: [
      {
        name: "Attributes",
        type: "string",
        description: "Task attributes JSON",
      },
    ],
    optionalParams: [
      {
  ...
  },
  {
    ...
    requiredParams: [
      { name: "UniqueName", type: "string", description: "Room name" },
      {
        name: "Type",
        type: "string",
        description: "Room type for live streaming",
      },
    ],
    optionalParams: [
      {
        ...
        type: "boolean",
        description: "Auto-record participants",
      },
    ],
    ...
    requiredParams: [
      {
        name: "StatusCallback",
        type: "string",
        description: "Status webhook URL",
      },
    ],
    optionalParams: [
      {
    ...
    optionalParams: [
      {
        name: "VideoLayout",
        type: "object",
        description: "Video layout configuration",
      },
      {
        name: "AudioSources",
        type: "array",
  ...
  },
  {
    ...
    lastUsed: "4 hours ago",
    documentation:
      "https://www.twilio.com/docs/voice/insights/call-summary-api",
    requiredParams: [
    ...
    optionalParams: [
      {
        ...
        type: "string",
        description: "Processing state filter",
      },
    ],
    pricing: { cost: "$0.005", unit: "per call analyzed" },
  },
    ...
    optionalParams: [
      {
        name: "Token",
        type: "string",
        description: "Flex token for authentication",
      },
    ],
...
export const TWILIO_BUSINESS_CATEGORIES = [
  {
    ...
    icon: "Shield",
    description:
      "Phone verification, 2FA, identity validation, and security services",
    color: "text-blue-600",
    subcategories: [
  ...
  },
  {
    ...
    icon: "Users",
    description:
      "Support channels, customer communication, and engagement tools",
  ...
  },
  {
    ...
    icon: "Video",
    description:
      "Video consultations, premium features, and value-added services",
  ...
  },
  {
    ...
    icon: "BarChart3",
    description:
      "Usage tracking, performance analytics, and business intelligence",
