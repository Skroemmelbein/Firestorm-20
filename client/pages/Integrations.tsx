...
export default function Integrations() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] nexus-theme">
      ...
      <div className="f10-command-header" style={{ background: "linear-gradient(135deg, #001a1a 0%, #002d2d 100%)" }}>
        <div className="f10-command-title">
          <Network className="w-8 h-8 text-[#00CED1]" />
          <div>
            <h1 className="f10-heading-lg text-white">NEXUS SYNC</h1>
            <p className="f10-command-subtitle">Integration Command & Data Flow Control</p>
          </div>
        </div>
        <div className="f10-command-status">
          <div className="f10-env-status">
            <div className="f10-status-dot"></div>
            <span>{metrics.activeConnections}/{metrics.totalIntegrations} Systems Online</span>
          </div>
          <div className="f10-env-status">
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="space-y-6">
          ...
          <TabsContent value="command" className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="f10-heading-md text-white">Integration Command Center</h2>
                <p className="f10-text-sm text-[#b3b3b3] mt-1">Manage API connections, data flows, and system integrations</p>
              </div>
            ...
            <div className="space-y-4">
              {integrations.map((integration) => {
                ...
                return (
                  <div key={integration.id} className="f10-card hover:accent-glow transition-all">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="f10-text-lg font-semibold text-white">{integration.name}</h3>
                    ...
                    <p className="f10-text-sm text-[#b3b3b3] mb-4">{integration.description}</p>
                    ...
                    <div className="grid grid-cols-5 gap-6">
                      ...
                      <div className="text-center">
                        ...
                        <div className="f10-text-xs text-[#737373]">REQUESTS</div>
                      </div>
                      <div className="text-center">
                        <div className="f10-text-sm font-semibold text-[#FFD700]">
                          {integration.errorRate}%
                        </div>
                        <div className="f10-text-xs text-[#737373]">ERROR RATE</div>
                      </div>
                      <div className="text-center">
                      ...
                      <div className="text-center">
                        ...
                        <div className="f10-text-xs text-[#737373]">ENDPOINT</div>
                      </div>
                    </div>
                    ...
                    <div className="mt-4">
                      <div className="flex justify-between items-center mb-2">
                        <span className="f10-text-xs text-[#737373]">System Health</span>
                        <span className="f10-text-xs font-medium text-white">{integration.health}%</span>
                      </div>
          ...
          <TabsContent value="monitoring" className="space-y-6">
            <div className="text-center py-12">
              ...
              <h3 className="f10-heading-sm text-white mb-2">Real-Time System Monitoring</h3>
              <p className="f10-text-sm text-[#b3b3b3] max-w-md mx-auto">
                Advanced monitoring dashboard for API performance, data flows, and system health
              </p>
          ...
          <TabsContent value="security" className="space-y-6">
            <div className="text-center py-12">
              ...
              <h3 className="f10-heading-sm text-white mb-2">Security Control Center</h3>
              <p className="f10-text-sm text-[#b3b3b3] max-w-md mx-auto">
                API security, access control, and threat monitoring for all integrations
              </p>
              <Button className="f10-btn accent-bg text-black font-medium mt-6">
                <Shield className="w-4 h-4 mr-2" />
                Security Settings
          ...
          <TabsContent value="settings" className="space-y-6">
            <div className="text-center py-12">
              ...
              <h3 className="f10-heading-sm text-white mb-2">System Configuration</h3>
              <p className="f10-text-sm text-[#b3b3b3] max-w-md mx-auto">
