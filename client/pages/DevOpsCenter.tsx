...
export default function DevOpsCenter() {
  ...
  const runScript = async (scriptId: string) => {
    ...
    setExecutionLog((prev) => [
      ...prev,
      `[${new Date().toISOString()}] Starting ${script.script}...`,
    ]);
  ...
  const runAutoWire = async () => {
    ...
    setExecutionLog((prev) => [
      ...prev,
      "[AUTO-WIRE] Starting full automation pipeline...",
    ]);
    ...
    setExecutionLog((prev) => [
      ...prev,
      "[AUTO-WIRE] All systems synchronized successfully!",
    ]);
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold gradient-text tracking-tight">
              DevOps Automation Center
            </h1>
            <p className="text-blue-700/70 font-medium">
              Full-stack automation pipeline: DB ➜ APIs ➜ GPT ➜ Builder ➜ Live
              sync
            </p>
          </div>
          <div className="flex gap-2">
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://cdn.builder.io/api/v1/image/assets%2F95d0350cdfe84eb4a176cb0cbfe48451%2Ff5914ebf80d94f428051634c5b2ed6ca?format=webp&width=800",
                  "_blank",
                )
              }
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {[
                ...
                const CategoryIcon = getCategoryIcon(
                  category as AutomationScript["category"],
                );
                              ...
                              <div className="text-xs text-blue-600/60">
                                {script.lastRun ? (
                                  <div className="flex items-center justify-between">
                                    ...
                                    {script.duration && (
                                      <span>{script.duration.toFixed(1)}s</span>
                                    )}
                                  </div>
                                ) : (
                                  <span>Never run</span>
          ...
          <TabsContent value="pipeline" className="space-y-4">
            <Card className="glass-card corp-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Visual representation of the complete DB ➜ APIs ➜ GPT ➜
                  Builder ➜ Live sync flow
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4 p-4 glass-card rounded-lg">
                    ...
                    <ArrowRight className="w-4 h-4 text-blue-600/50" />
                    <div className="text-sm text-blue-600/70">
                      HIPAA/GDPR/PCI checks → Security validation → Go-live
                      approval
                    </div>
                  </div>
                </div>
          ...
          <TabsContent value="monitoring" className="space-y-4">
            ...
            <Alert className="border-green-200 bg-green-50">
              ...
              <AlertDescription className="text-green-700">
                All automation scripts are functioning normally. Last full
                auto-wire completed successfully 2 hours ago.
              </AlertDescription>
            </Alert>
          </TabsContent>
                ...
                <div className="bg-black/90 text-green-400 p-4 rounded-lg font-mono text-sm h-64 overflow-y-auto">
                  {executionLog.length > 0 ? (
                    ...
                    <div className="text-green-400/50">
                      No recent executions. Run a script to see live logs...
                    </div>
                  )}
                </div>
              </CardContent>
