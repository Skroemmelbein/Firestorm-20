...
export default function AdminDashboard() {
  ...
  const [uploadStep, setUploadStep] = useState<
    "upload" | "scan" | "preview" | "joiner" | "destination"
  >("upload");
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-700/70 font-medium">
              Enterprise billing infrastructure management
            </p>
          </div>
          ...
          <Card className="glass-card corp-shadow">
            ...
            <CardContent>
              <div className="text-2xl font-bold gradient-text">
                {systemStats.totalSubscriptions.toLocaleString()}
              </div>
          ...
          <TabsContent value="uploads" className="space-y-4">
            <Card className="glass-card corp-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Upload multiple spreadsheets with smart scanning and table
                    ...
                    <div className="border-2 border-dashed border-blue-300 rounded-lg p-8 text-center hover:border-blue-500 transition-colors">
                      ...
                      >
                        ...
                        <p className="text-blue-600/70 mb-4">
                          Drag and drop or click to select up to 5 files
                        </p>
                  ...
                  <div className="text-center space-y-6">
                    <div className="space-y-3">
                      ...
                      <h3 className="text-xl font-bold text-blue-800">
                        Scan for Unique Identifiers?
                      </h3>
                      <p className="text-blue-600/70 max-w-md mx-auto">
                        Would you like me to scan all uploaded files and find
                        common unique identifiers for data joining?
                      </p>
                    </div>
                    ...
                    {isScanning ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-blue-600/70">
                          Analyzing data structure and identifying common fields
                        </p>
                      </div>
                    ) : (
                      scanResults && (
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <Card className="p-4">
                                ...
                                <div className="space-y-1">
                                  {scanResults.commonIdentifiers.map(
                                    (id, index) => (
                                      <Badge
                                        key={index}
                                        variant="outline"
                              ...
                              <Card className="p-4">
                                ...
                                <div className="space-y-2">
                                  {scanResults.suggestedJoins.map(
                                    (join, index) => (
                          ...
                          <div className="text-center space-y-4">
                            ...
                            <p className="text-blue-600/70">
                              Would you like to create a new joined table with
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-green-600/70">
                                  Create new Xano table with API
                                </p>
                              </div>
                            </div>
                          </Card>
                        ...
                        {!createNewTable ? (
                          <div>
                            ...
                            <Select
                              value={selectedXanoTable}
                              onValueChange={setSelectedXanoTable}
                            >
                              <SelectTrigger>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="billing_history">
                                  Billing History
                                </SelectItem>
                              </SelectContent>
                            </Select>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="p-3 bg-green-50 rounded border border-green-200">
                              <p className="text-sm text-green-700">
                                ...
                                API endpoint will be automatically created:{" "}
                                <code>/api/{newTableName}</code>
                              </p>
                            </div>
                          </div>
                        )}
                    ...
                    <div className="flex gap-4 justify-center">
                      <Button
                        ...
                        disabled={
                          isProcessing ||
                          (!createNewTable && !selectedXanoTable) ||
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    {
                      time: "2 minutes ago",
                      event: "Billing cycle completed for 150 subscriptions",
                      type: "success",
                    },
                    {
                      time: "5 minutes ago",
                      event: "NMI vault sync initiated",
                      type: "info",
                    },
                    {
                      time: "10 minutes ago",
                      event: "3 failed payment retries processed",
                      type: "warning",
                    },
                    {
                      time: "15 minutes ago",
                      event: "Twilio SMS campaign sent to 45 customers",
                      type: "success",
                    },
                    {
                      time: "30 minutes ago",
                      event: "New subscription created via API",
                      type: "success",
                    },
                  ].map((activity, index) => (
                    <div
