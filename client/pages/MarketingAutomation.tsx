        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-[#1E1E22] border border-[#FF2D55]/30 p-6 hover:border-[#FF2D55] transition-colors supreme-glow">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-[#FF2D55] font-bold">
                AI-DRIVEN
              </span>
            </div>
          </div>
        ...
        >
          ...
          <TabsContent value="journeys" className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              <div className="bg-[#1E1E22] border border-[#00E676]/30 p-6">
                <h3 className="text-lg font-black text-[#00E676] uppercase mb-4">
                  ACTIVE JOURNEYS
                </h3>
              ...
              <div className="bg-[#1E1E22] border border-[#FFD700]/30 p-6">
                <h3 className="text-lg font-black text-[#FFD700] uppercase mb-4">
                  CONVERSION RATE
                </h3>
                <div className="text-4xl font-black text-white mb-2">34.7%</div>
                <div className="text-xs text-gray-400 uppercase">
                  AVERAGE ACROSS JOURNEYS
                </div>
              </div>

              <div className="bg-[#1E1E22] border border-[#FF2D55]/30 p-6">
                <h3 className="text-lg font-black text-[#FF2D55] uppercase mb-4">
                  JOURNEY TIME
                </h3>
            ...
            <div className="bg-[#1E1E22] border border-[#FF6A00]/30 p-8">
              <h3 className="text-xl font-black text-[#FF6A00] uppercase mb-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm font-bold text-[#FF6A00]">
                        {((campaign.conversions / campaign.sent) * 100).toFixed(
                          1,
                        )}
                        %
                      </span>
                    ...
                    <div className="w-full h-1 bg-[#1E1E22]">
                      <div
                        ...
                        style={{
                          width: `${(campaign.conversions / campaign.sent) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
          ...
          <TabsContent value="analysis" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-[#1E1E22] border border-[#FF6A00]/30 p-6">
                ...
                <div className="text-xs text-[#FF6A00] font-bold mt-2">
                  98.7% DELIVERY
                </div>
              </div>
              ...
              <div className="bg-[#1E1E22] border border-[#FF2D55]/30 p-6">
                ...
                <div className="text-xs text-[#FF2D55] font-bold mt-2">
                  ABOVE INDUSTRY
                </div>
              </div>
              ...
              <div className="bg-[#1E1E22] border border-[#FFD700]/30 p-6">
                ...
                <div className="text-xs text-[#FFD700] font-bold mt-2">
                  5.6% RATE
                </div>
              </div>
            </div>
          ...
          <TabsContent value="audience" className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1E22] border border-[#FF6A00]/30 p-6">
                <h3 className="text-lg font-black text-[#FF6A00] uppercase mb-4">
                  ABANDONED CARTS
                </h3>
          ...
          <TabsContent value="analytics" className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-[#1E1E22] border border-[#FF2D55]/30 p-6">
                <h3 className="text-lg font-black text-[#FF2D55] uppercase mb-6">
                  AI EFFECTIVENESS
                </h3>
                <div className="text-center">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border border-[#00E676]/30">
                    <div>
                      ...
                      <div className="text-sm text-[#FF6A00]">
                        +1 (855) 960-0037
                      </div>
                    </div>
