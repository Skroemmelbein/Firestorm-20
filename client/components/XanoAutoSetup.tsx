    ...
    <div className="space-y-6">
      ...
      <Card className="glass-card corp-shadow border-blue-200">
        <CardHeader>
          ...
          <CardDescription>
            Complete automated setup of your Xano database, tables, and API endpoints using your credentials
          </CardDescription>
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-3 bg-blue-50 rounded-lg">
              ...
              <div className="font-mono text-sm text-blue-600">{xanoCredentials.email}</div>
            </div>
            
            <div className="p-3 bg-blue-50 rounded-lg">
              <div className="text-sm font-medium text-blue-800">Workspace</div>
              <div className="font-mono text-sm text-blue-600">{xanoCredentials.workspace}</div>
            </div>
          </div>
          ...
          <Alert>
            ...
            <AlertDescription>
              ✅ <strong>Credentials verified!</strong> The automated setup will use these to configure your Xano workspace.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
