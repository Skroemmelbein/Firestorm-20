  ...
  const testConnection = async () => {
    ...
    try {
      ...
      const response = await openai.chat([
        {
          role: "user",
          content: 'Say "Connection successful" if you can respond.',
        },
      ]);
    ...
    <div className="space-y-6">
      ...
      <Card className="glass-card corp-shadow">
        <CardHeader>
          ...
          <CardDescription>
            Type or speak what you want me to do. Examples: "Send test SMS",
            "Create a user form", "Fix the login"
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex gap-2">
            <Input
              ...
              placeholder="Tell me what to do... (e.g., 'Send a test SMS to 855-960-0037')"
              className="flex-1"
            />
