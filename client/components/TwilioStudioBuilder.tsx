      ...
      data: {
        ...
        message:
          type === "send_message"
            ...
            : undefined,
        condition:
          type === "conditional" ? 'input.body contains "help"' : undefined,
      },
    };
      ...
      <div
        className={`absolute cursor-pointer transform transition-all duration-300 hover:scale-110 hover:shadow-2xl ${
          selectedNode?.id === node.id
            ? "ring-2 ring-[#FF6A00] shadow-[#FF6A00]/50"
            : ""
        }`}
        style={{
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">
                    Start Building Your AI Flow
                  </h3>
                  <p className="text-gray-400 mb-4">
                    Add components from the palette or generate an AI flow
                  </p>
                  <Button
                    onClick={generateAIFlow}
                    ...
                    onChange={(e) => {
                      const updatedNodes = nodes.map((n) =>
                        n.id === selectedNode.id
                          ? {
                              ...n,
                              data: { ...n.data, message: e.target.value },
                            }
                          : n,
                      );
                      setNodes(updatedNodes);
