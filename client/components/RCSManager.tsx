          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div
                ...
                style={{
                  color: getStatusColor(currentAgent.verificationStatus),
                }}
              >
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        variant="outline"
                        onClick={() =>
                          navigator.clipboard.writeText(currentAgent.agentId)
                        }
                        className="f10-btn"
                      >
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {currentAgent.capabilities.map((cap) => (
                        <Badge
                          key={cap}
                          className="bg-[#00E676]/20 text-[#00E676] border-[#00E676]/40 text-xs"
                        >
                          {cap}
                        </Badge>
                      ))}
              ...
              <Card className="p-4">
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    disabled={
                      isLoading.testing || currentAgent.status !== "active"
                    }
                    className="w-full f10-btn accent-bg text-black"
                  >
                    {isLoading.testing ? (
              ...
              <Card className="p-4">
                ...
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {recentMessages.map((message) => (
                    <div
                      key={message.id}
                      className="bg-[#0a0a0a] border border-[#333333] rounded p-3"
                    >
            ...
            <Card className="p-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1">
                    {webhookConfig.events.map((event) => (
                      <Badge
                        key={event}
                        className="bg-[#00BFFF]/20 text-[#00BFFF] border-[#00BFFF]/40"
                      >
                        {event}
                      </Badge>
                    ))}
                ...
                <div className="bg-[#FFD700]/10 border border-[#FFD700]/30 rounded-lg p-3">
                  <h5 className="font-semibold text-[#FFD700] mb-2">
                    Webhook Endpoint
                  </h5>
          ...
          <TabsContent value="analytics" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="p-4 text-center">
                <div className="text-3xl font-bold text-[#00E676] mb-2">
                  {currentAgent.messagesSent}
                </div>
            ...
            <Card className="p-4">
              <h4 className="font-semibold text-white mb-3">
                RCS Features & Benefits
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="font-medium text-[#00E676] mb-2">
                    Rich Media Support
                  </h5>
