...
import {
  ...
  type ComprehensiveTheme,
} from "@/data/comprehensive-themes";
...
export default function SkinCustomizer() {
  const [selectedTheme, setSelectedTheme] = useState<ComprehensiveTheme>(
    COMPREHENSIVE_THEMES[0],
  );
  const [customTheme, setCustomTheme] = useState<ComprehensiveTheme>(
    COMPREHENSIVE_THEMES[0],
  );
  ...
  const updateCustomThemeColor = (
    colorKey: keyof ComprehensiveTheme["colors"],
    value: string,
  ) => {
    setCustomTheme((prev) => ({
      ...prev,
          ...
          <TabsContent value="themes" className="space-y-4">
            <div className="mb-4">
              <h4 className="font-semibold text-white mb-2">
                🎨 {COMPREHENSIVE_THEMES.length} Professional Themes Available
              </h4>
              <p className="text-sm text-[#b3b3b3]">
                Choose from Executive Command, Velocify Ops, FIRESTORM, Dream
                Portal, Nexus Sync, Zero-CB Fortress, Creative, Minimal,
                Futuristic, and Luxury categories
              </p>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label className="text-[#b3b3b3]">
                    Border Radius: {customTheme.spacing.radius}px
                  </Label>
                  <input
                    type="range"
                ...
                <div className="space-y-2">
                  <Label className="text-[#b3b3b3]">
                    Spacing Scale: {customTheme.spacing.scale}x
                  </Label>
                  <input
                    type="range"
            ...
            <div className="bg-[#1a1a1a] border border-[#333333] rounded-lg p-6">
              ...
              >
                ...
                >
                  ...
                  <p
                    className="text-sm"
                    style={{ color: customTheme.colors.muted }}
                  >
