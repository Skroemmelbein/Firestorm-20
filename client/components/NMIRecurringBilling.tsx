...
export default function NMIRecurringBilling() {
  ...
  const createNewPlan = async () => {
    ...
    setPlans([...plans, plan]);
    setNewPlan({ name: '', amount: 0, frequency: 'monthly', xanoTable: '', description: '' });
  };

  const getStatusColor = (status: string) => {
    switch (status) {
      case 'active': case 'processed': case 'approved': return '#00E676';
      case 'pending': return '#FFD700';
      case 'failed': case 'cancelled': return '#FF2D55';
      case 'paused': return '#FF6A00';
      ...
      <div className="border-b border-[#00E676]/20 bg-black/90 backdrop-blur-xl p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black text-white">NMI RECURRING BILLING MATRIX</h1>
              <p className="text-sm text-[#00E676]">Xano → NMI → Twilio Integration</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1 bg-[#00E676]/20 border border-[#00E676]/50">
              ...
              <span className="text-xs font-bold text-[#00E676]">XANO LIVE</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-1 bg-[#00E676]/20 border border-[#00E676]/50">
              <CreditCard className="w-4 h-4 text-[#00E676]" />
              <span className="text-xs font-bold text-[#00E676]">NMI VAULT</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-1 bg-[#00E676]/20 border border-[#00E676]/50">
              <Zap className="w-4 h-4 text-[#00E676]" />
              <span className="text-xs font-bold text-[#00E676]">TWILIO SMS</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-[#1E1E22] border border-[#00E676]/30 p-6 supreme-float">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xs font-bold text-[#00E676] uppercase tracking-wider">XANO DATABASE</h3>
              <Database className="w-4 h-4 text-[#00E676]" />
            </div>
            <div className="flex items-center gap-3">
              <div className="w-3 h-3 bg-[#00E676] animate-pulse"></div>
              <span className="text-sm font-bold text-white">CONNECTED & SYNCED</span>
            </div>
          ...
          <div className="bg-[#1E1E22] border border-[#32CD32]/30 p-6 supreme-float">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xs font-bold text-[#32CD32] uppercase tracking-wider">NMI VAULT</h3>
            ...
            <div className="text-xs text-gray-400 mt-2">Processing recurring charges</div>
          </div>

          <div className="bg-[#1E1E22] border border-[#20B2AA]/30 p-6 supreme-float">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xs font-bold text-[#20B2AA] uppercase tracking-wider">TWILIO SMS</h3>
              <Zap className="w-4 h-4 text-[#20B2AA]" />
            </div>
            <div className="flex items-center gap-3">
              <div className="w-3 h-3 bg-[#20B2AA] animate-pulse"></div>
              <span className="text-sm font-bold text-white">NOTIFICATIONS LIVE</span>
            </div>
            <div className="text-xs text-gray-400 mt-2">Webhooks configured</div>
          </div>
        </div>

        {/* Billing Flow Diagram */}
        <div className="bg-[#1E1E22] border border-[#00E676]/30 p-8 mb-8 supreme-glow">
          <h3 className="text-xl font-black text-[#00E676] uppercase mb-6">AUTOMATED BILLING FLOW</h3>
          <div className="flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <div className="bg-[#1E1E22] border border-[#00E676]/30 p-6">
            <h3 className="text-lg font-black text-[#00E676] uppercase mb-6">ACTIVE RECURRING PLANS</h3>
            <div className="space-y-4">
              {plans.map((plan) => (
                <div key={plan.id} className="bg-[#2A2A2E] border border-[#00E676]/20 p-4 supreme-shimmer">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-md font-bold text-white">{plan.name}</h4>
                    <div 
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <span className="text-[#00E676] font-bold">${plan.amount}</span>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <span className="text-[#00E676] font-bold">{plan.subscribers}</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Xano Table: </span>
                      <span className="text-white font-mono text-xs">{plan.xanoTable}</span>
                    </div>
                  </div>
                  <div className="flex gap-2 mt-4">
                    ...
                    <Button size="sm" variant="outline" className="border-[#00E676]/50 text-[#00E676]">
          ...
          <div className="bg-[#1E1E22] border border-[#32CD32]/30 p-6">
            <h3 className="text-lg font-black text-[#32CD32] uppercase mb-6">CREATE NEW PLAN</h3>
            <div className="space-y-4">
              <div>
              ...
              <div>
                ...
                <Input 
                  ...
                  onChange={(e) => setNewPlan({...newPlan, xanoTable: e.target.value})}
                  className="bg-[#2A2A2E] border-[#32CD32]/30 text-white"
        ...
        <div className="bg-[#1E1E22] border border-[#20B2AA]/30 p-6">
          <h3 className="text-lg font-black text-[#20B2AA] uppercase mb-6">RECENT BILLING EVENTS</h3>
          <div className="space-y-3">
            {billingEvents.map((event) => (
              <div key={event.id} className="flex items-center justify-between p-3 bg-[#2A2A2E] border border-[#20B2AA]/20">
                <div className="flex items-center gap-3">
                  <div 
                    className="w-3 h-3"
                    style={{
