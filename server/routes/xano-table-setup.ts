...
const ECELONX_TABLE_SCHEMAS = {
  ...
  users: {
    ...
    fields: [
      ...
      { name: "role", type: "enum", values: ["admin", "manager", "user"], default: "user" },
  ...
  clients: {
    ...
    fields: [
      ...
      { name: "subscription_tier", type: "enum", values: ["basic", "professional", "enterprise"], default: "basic" },
      { name: "account_status", type: "enum", values: ["active", "trial", "suspended", "cancelled"], default: "trial" },
  ...
  members: {
    ...
    fields: [
      ...
      { name: "tier", type: "enum", values: ["basic", "premium", "elite", "executive"], default: "basic" },
      { name: "status", type: "enum", values: ["active", "inactive", "pending", "suspended"], default: "pending" },
  ...
  communications: {
    ...
    fields: [
      { name: "id", type: "integer", auto_increment: true, primary: true },
      { name: "channel", type: "enum", values: ["sms", "email", "voice", "chat"], required: true },
      ...
      { name: "status", type: "enum", values: ["queued", "sent", "delivered", "failed", "bounced"], default: "queued" },
      { name: "provider", type: "enum", values: ["twilio", "sendgrid", "other"], required: true },
  ...
  conversations: {
    ...
    fields: [
      ...
      { name: "state", type: "enum", values: ["active", "inactive", "closed"], default: "active" },
      { name: "client_id", type: "integer", foreign_key: "clients.id" },
  ...
  conversation_messages: {
    ...
    fields: [
      { name: "id", type: "integer", auto_increment: true, primary: true },
      { name: "conversation_id", type: "integer", foreign_key: "conversations.id", required: true },
  ...
  campaigns: {
    ...
    fields: [
      ...
      { name: "type", type: "enum", values: ["email", "sms", "voice", "multi"], required: true },
      { name: "status", type: "enum", values: ["draft", "active", "paused", "completed"], default: "draft" },
  ...
  integrations: {
    ...
    fields: [
      { name: "id", type: "integer", auto_increment: true, primary: true },
      { name: "name", type: "text", required: true },
      { name: "type", type: "enum", values: ["api", "database", "service", "webhook"], required: true },
      { name: "provider", type: "text", required: true },
      { name: "status", type: "enum", values: ["connected", "disconnected", "error", "pending"], default: "pending" },
  ...
  chargebacks: {
    ...
    fields: [
      ...
      { name: "category", type: "enum", values: ["fraud", "processing", "authorization", "consumer"], required: true },
      { name: "status", type: "enum", values: ["pending", "disputed", "won", "lost", "prevented"], default: "pending" },
  ...
  subscriptions: {
    ...
    fields: [
      { name: "id", type: "integer", auto_increment: true, primary: true },
      { name: "client_id", type: "integer", foreign_key: "clients.id", required: true },
      { name: "subscription_id", type: "text", unique: true, required: true },
      { name: "plan_name", type: "text", required: true },
      { name: "plan_type", type: "enum", values: ["monthly", "yearly", "custom"], default: "monthly" },
      { name: "amount", type: "float", required: true },
      { name: "currency", type: "text", default: "USD" },
      { name: "status", type: "enum", values: ["active", "paused", "cancelled", "expired"], default: "active" },
  ...
  transactions: {
    ...
    fields: [
      ...
      { name: "amount", type: "float", required: true },
      { name: "currency", type: "text", default: "USD" },
      { name: "type", type: "enum", values: ["charge", "refund", "chargeback"], default: "charge" },
      { name: "status", type: "enum", values: ["pending", "completed", "failed", "cancelled"], default: "pending" },
      { name: "processor", type: "text", default: "NMI" },
  ...
  system_logs: {
    ...
    fields: [
      { name: "id", type: "integer", auto_increment: true, primary: true },
      { name: "level", type: "enum", values: ["info", "warning", "error", "critical"], required: true },
  ...
  customer_segments: {
    ...
    fields: [
      ...
      { name: "name", type: "text", required: true },
      { name: "description", type: "text" },
      { name: "type", type: "enum", values: ["behavioral", "demographic", "psychographic", "geographic"], required: true },
      { name: "criteria", type: "json", required: true },
      { name: "audience_size", type: "integer", default: 0 },
      { name: "conversion_rate", type: "float", default: 0 },
      { name: "engagement_score", type: "float", default: 0 },
      { name: "status", type: "enum", values: ["active", "inactive", "building"], default: "building" },
      { name: "created_by", type: "integer", foreign_key: "users.id" },
      { name: "created_at", type: "datetime", auto_timestamp: true },
      { name: "updated_at", type: "datetime", auto_timestamp: true }
    ]
...
export const createAllTables: RequestHandler = async (req, res) => {
  try {
    ...
    console.log("🚀 Starting ECELONX table creation on upgraded Xano instance...");
