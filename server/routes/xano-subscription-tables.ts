...

  {
    ...
    columns: [
      ...
      { name: "plan_id", type: "text" },
      {
        name: "status",
        type: "enum",
        values: ["active", "paused", "cancelled", "past_due", "unpaid"],
      },
...

  {
    ...
    columns: [
      ...
      { name: "nmi_vault_id", type: "text", indexed: true },
      {
        name: "type",
        type: "enum",
        values: ["credit_card", "debit_card", "bank_account"],
      },
      {
        name: "provider",
        type: "enum",
        values: ["nmi", "stripe", "square", "paypal"],
      },
...

  {
    ...
    columns: [
      ...
      { name: "nmi_transaction_id", type: "text", unique: true, indexed: true },
      {
        ...
        type: "enum",
        values: ["subscription_payment", "refund", "chargeback", "adjustment"],
      },
      { name: "amount", type: "decimal", precision: 10, scale: 2 },
