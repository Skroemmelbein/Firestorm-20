...
const TWILIO_PHONE_NUMBER = '+18558000037';
...
async function sendTestMessage() {
  try {
    console.log('🚀 Sending test message to 8144409068...');
    
    const formattedPhone = '+18144409068';
...
router.post('/webhook/status', async (req, res) => {
  try {
    ...
    console.log(`📊 SMS Status Update - SID: ${MessageSid}, Status: ${MessageStatus}`);
