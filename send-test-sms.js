...
const sendTestSMS = async () => {
  try {
    ...
    const response = await fetch('https://c57c3ee55ba54f0c81c1553aa0f19682-161e9f22b0c34c888a2e08047.fly.dev/api/real/sms/send', {
      method: 'POST',
      headers: {
      ...
      body: JSON.stringify({
        to: '+18144409968',
        body: '🚀 Test SMS from RecurFlow! Your enterprise SMS system is working perfectly. Sent at ' + new Date().toLocaleString() + ' from your admin dashboard.'
      })
    });
